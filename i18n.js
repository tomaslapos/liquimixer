...
async function loadLocales() {
    try {
        ...
        localesData = [
            ...
            { code: 'pl', name: 'Polish', native_name: 'Polski', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            ...
            { code: 'ja', name: 'Japanese', native_name: '日本語', currency: 'USD', currency_symbol: '$', date_format: 'YYYY/MM/DD', is_active: true },
            { code: 'ko', name: 'Korean', native_name: '한국어', currency: 'USD', currency_symbol: '$', date_format: 'YYYY.MM.DD', is_active: true },
            { code: 'tr', name: 'Turkish', native_name: 'Türkçe', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            { code: 'uk', name: 'Ukrainian', native_name: 'Українська', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            { code: 'ru', name: 'Russian', native_name: 'Русский', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            { code: 'sv', name: 'Swedish', native_name: 'Svenska', currency: 'EUR', currency_symbol: '€', date_format: 'YYYY-MM-DD', is_active: true },
            { code: 'da', name: 'Danish', native_name: 'Dansk', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            { code: 'no', name: 'Norwegian', native_name: 'Norsk', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            ...
            { code: 'ar-SA', name: 'Arabic', native_name: 'العربية', currency: 'USD', currency_symbol: '$', date_format: 'DD/MM/YYYY', is_active: true },
            { code: 'zh-CN', name: 'Chinese (Simplified)', native_name: '简体中文', currency: 'USD', currency_symbol: '$', date_format: 'YYYY-MM-DD', is_active: true },
            { code: 'zh-TW', name: 'Chinese (Traditional)', native_name: '繁體中文', currency: 'USD', currency_symbol: '$', date_format: 'YYYY/MM/DD', is_active: true },
            { code: 'hu', name: 'Hungarian', native_name: 'Magyar', currency: 'EUR', currency_symbol: '€', date_format: 'YYYY.MM.DD', is_active: true },
            ...
            { code: 'ro', name: 'Romanian', native_name: 'Română', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            { code: 'hr', name: 'Croatian', native_name: 'Hrvatski', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            { code: 'bg', name: 'Bulgarian', native_name: 'Български', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true },
            { code: 'sr', name: 'Serbian', native_name: 'Српски', currency: 'EUR', currency_symbol: '€', date_format: 'DD.MM.YYYY', is_active: true }
        ];
    } catch (err) {
